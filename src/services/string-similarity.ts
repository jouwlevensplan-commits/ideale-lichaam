/**
 * Kleine, dependency-vrije stringgelijkenis-helper voor het rangschikken van zoekresultaten uit de
 * statische generieke-voedingcatalogus (`data/generic-foods.ts`) — geen databasefunctie of
 * -extensie nodig (dus geen `pg_trgm`), volledig veilig op managed Postgres zonder
 * SUPERUSER-rechten en zonder enige databasetoegang.
 */
