 ...
 * Gebruikt `upsert` (niet `findOrCreate`): dit zijn statische naslagwaarden zonder gebruikersdata
 * eromheen, dus latere aanpassingen aan deze lijst (bv. de tweetalige namen/populariteit die in
 * een eerdere versie van deze seed nog ontbraken) moeten bij elke herstart doorgevoerd worden op al
 * bestaande rijen, niet enkel bij het aanmaken van nieuwe.
 */
